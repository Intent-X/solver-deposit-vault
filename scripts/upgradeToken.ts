...
async function main() {
    ...
    const contract = await upgrades.upgradeProxy("0xB6d340Af68279326402139C30934317929535D32", Factory, {
    ...
    try {
        ...
        await run("verify:verify", {address: await upgrades.erc1967.getImplementationAddress(await contract.getAddress())})
